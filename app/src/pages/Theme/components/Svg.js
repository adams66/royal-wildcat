 ...
 var rotate = props.rotate;
    ...
    function click(theme) {
        ...
        case 2:
            return(
                <div style={{height:"100%"}}  className="col d-flex justify-content-center">
                <div  onMouseEnter={() => hover("red")} onMouseLeave={() => hoveroff("white")}			onClick={() => { click('chief');
                }} className="col-12 d-flex justify-content-center logo">
                <svg
                className="chief-svg"
            ...
            return(
                <div style={{height:"100%"}}  className="col d-flex justify-content-center">
                <div  onMouseEnter={() => hover("gold")} onMouseLeave={() => hoveroff("white")}			onClick={() => { click('shocker');
                }} className="col-12 d-flex justify-content-center logo">
                <svg
            ...
            return(
                <div style={{height:"100%"}}  className="col d-flex justify-content-center">
                <div  onMouseEnter={() => hover("rgb(102,16,242)")} onMouseLeave={() => hoveroff("white")}			onClick={() => { click('jayhawk');
                }} className="col-12 d-flex justify-content-center logo">
                <svg
